function [m,fm,whole] = asqm_3(f,K,u,a,fa,b,fb)
% Splits f from a to b down the middle and calculates its asq value
% 
% Takes the integrand function f, constant arugments K and u,
% bounds a and b, and the function evaluated at those bounds, fa and fb
